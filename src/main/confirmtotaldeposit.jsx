...
export default function ConfirmTotalDeposit({ onCancel}) {
    ...
    <div className="modal-overlay">
      <div className="modal-content">
          <div style={{overflowY: 'auto', padding: '10px' }}>
                    <h3 style={{marginBottom:"1rem"}}>Deposit List</h3>
                    {groupLists.length === 0 ? (
                        <p>No User found</p>
                    ) : (
                            ...
                            {groupLists.map((list, index) => (
                                <li key={list._id} style={{ marginBottom: '10px', padding: '10px', border: '1px solid #ddd' }}>
                                    <div style={{
                                        ...
                                        <p><strong>{list.name}-{list.deposit}<FaBangladeshiTakaSign/></strong></p>
                                        </div>
                                     </li>
                            ))}
                        </ul>
